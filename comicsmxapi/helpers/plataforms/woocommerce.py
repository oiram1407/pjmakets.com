...
class WooCommerceHelper:
    ...
    def getProductRelated(self):
        product_related = ProductsRelatedPlataform.objects.get(product=self._product_id, method=self._current_plataform)
        self._product_related_id = product_related.product_platform_id
